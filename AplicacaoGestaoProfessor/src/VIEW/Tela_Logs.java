...
public class Tela_Logs extends JPanel {
    ...
    private void inicializarComponentes() {
        ...
        modeloLogs = new DefaultTableModel(
            new Object[][] {
                {"Malik M", "Administrador", "Login", "Login efetuado com sucesso no sistema."},
                {"ED Mapotere", "operador", "Bloqueio", "Tentativa de exclusão de registro sem permissão total."},
                {"Malik M", "Administrador", "Cadastro", "Nova turma [TURMA-A] cadastrada com sucesso."},
                {"KennyPSS", "Secretaria", "Matrícula", "Matrícula [MAT-101] do formando efetivada com sucesso."}
            },
            new String[] {"Nome do Usuário", "Perfil", "Ação", "Descrição da Atividade"}
        ) {
            private static final long serialVersionUID = 1L;
            @Override
